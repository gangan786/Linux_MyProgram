...
BEGIN_MESSAGE_MAP(CMyProjectMFCDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMyProjectMFCDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMyProjectMFCDlg::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BUTTON3, &CMyProjectMFCDlg::OnBnClickedButton3)
END_MESSAGE_MAP()
...
//单击 连接 按钮 会调用本函数
void CMyProjectMFCDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
...
//单击 发包 按钮 会调用本函数
void CMyProjectMFCDlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMyProjectMFCDlg::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码	
	//Sleep(10000);
	//这里收包
